...
int InitPlatform(void)
{
    ...
    {
        TRACELOG(RL_E_LOG_WARNING, "DISPLAY: Memory platform requires software renderer (GRAPHICS_API_OPENGL_11_SOFTWARE)");
    ...
    TRACELOG(RL_E_LOG_INFO, "PLATFORM: MEMORY: Initialized successfully");
