...
int main(void)
{
    ...
    RLSetShaderValue(shdrRaymarch, marchLocs.screenCenter , &screenCenter , RL_E_SHADER_UNIFORM_VEC2);
    ...
    while (!RLWindowShouldClose())    // Detect window close button or ESC key
    {
        ...
        RLVector3 camDir = RLVector3Scale( RLVector3Normalize( RLVector3Subtract(camera.target, camera.position)) , camDist);
