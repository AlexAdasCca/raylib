...
int main(void)
{
    ...
    RLInitWindow(screenWidth, screenHeight, "raylib [text] example - font spritefont");
    ...
    RLFont font1 = RLLoadFont("resources/custom_mecha.png");          // Font loading
    RLFont font2 = RLLoadFont("resources/custom_alagard.png");        // Font loading
    RLFont font3 = RLLoadFont("resources/custom_jupiter_crash.png");  // Font loading
