...
int main(void)
{
    ...
    RLTexture2D background = RLLoadTexture("resources/cyberpunk_street_background.png");
    RLTexture2D midground = RLLoadTexture("resources/cyberpunk_street_midground.png");
    RLTexture2D foreground = RLLoadTexture("resources/cyberpunk_street_foreground.png");
    ...
    // De-Initialization
    //--------------------------------------------------------------------------------------
    RLUnloadTexture(background);  // Unload background texture
    RLUnloadTexture(midground);   // Unload midground texture
    RLUnloadTexture(foreground);  // Unload foreground texture
